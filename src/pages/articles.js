...
const FearuredArticle = ({ img, title, time, summary, link }) => {
  return (
    <li className="col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl relative dark:bg-dark dark:border-light">
      <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[1.8rem] bg-dark rounded-br-3xl" />
      <Link
        href={link}
        target="_blank"
...
const articles = () => {
  return (
    <>
      <Head>
        <title> Emmanuel | About Section </title>
        <meta name="description" content="Generated by create next app" />
      </Head>
      <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light">
        <Layout>
          <AnimateText
            text="Let us share knowledge"
            className="mb-16 lg:text-7xl sm:mb-8 sm:!text-6xl xs:!text-4xl"
          />
          <ul className="grid grid-cols-2 gap-16 md:grid-cols-1 md:gap-y-16lg:gap-8">
            <FearuredArticle
